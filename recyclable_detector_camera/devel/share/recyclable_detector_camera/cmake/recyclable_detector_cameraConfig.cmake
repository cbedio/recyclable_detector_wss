...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'recyclable_detector_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/samuelc/dev/recyclable_detector_wss/recyclable_detector_camera/src/recyclable_detector_camera/${idir}'.  ${_report}")
    endif()
