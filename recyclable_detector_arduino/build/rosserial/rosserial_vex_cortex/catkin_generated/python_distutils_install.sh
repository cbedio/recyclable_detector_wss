...
echo_and_run cd "/home/samuelc/dev/recyclable_detector_wss/recyclable_detector_arduino/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/samuelc/dev/recyclable_detector_wss/recyclable_detector_arduino/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/samuelc/dev/recyclable_detector_wss/recyclable_detector_arduino/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
